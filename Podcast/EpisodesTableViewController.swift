...
class EpisodesTableViewController: UITableViewController {
   ...
   var imagePoster:String = String()
    var poster:String = String()
    var url:String = ""
    var mp3URL:String = ""
    var toBePassedPoster:String = String()
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        toBePassedPoster = Episodes[indexPath.row].poster
...
extension EpisodesTableViewController:XMLParserDelegate{
...
//<itunes:image href="https://engineered.network/img/sleep/defaultEpisodeImage.jpg"/>
        ...
        if elementName == "tootimage"{
            if attributeDict["href"] != nil{
                let PSIValue = attributeDict["href"]! as String
                self.imagePoster = PSIValue
        ...
        func parser(_ parser: XMLParser, didEndElement elementName: String, namespaceURI: String?, qualifiedName qName: String?) {
            if elementName == "item" {
                let episode = Episode(enclosure: enclosure,titleText:titleText,poster: poster)
